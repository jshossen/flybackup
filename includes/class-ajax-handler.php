...
class Fly_Backup_Ajax_Handler {
    ...
    public function start_backup() {
        ...
        $backup_engine = new Fly_Backup_Backup_Engine();
    ...
    public function restore_backup() {
        ...
        $restore_engine = new Fly_Backup_Restore_Engine();
    ...
    public function get_health_status() {
        ...
        $health_check = new Fly_Backup_Health_Check();
    ...
    public function clear_logs() {
        ...
        global $wpdb;
        $table_name = $wpdb->prefix . 'fly_backup_logs';
